...
public class AddStudentView {
    ...
    public AddStudentView(UserRepository userRepository) {
    ...
    public void initialize() {
        ...
        Student newStudent = new Student(firstName, lastName, email, password, birthDate, albumNumber);
        boolean success = userRepository.insert(newStudent);
